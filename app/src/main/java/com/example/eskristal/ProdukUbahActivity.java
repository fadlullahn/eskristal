...
public class ProdukUbahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_produk_ubah);
        ...
        Glide.with(ProdukUbahActivity.this)
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        if (isDialogClose) {
                            ...
                            if (ID.trim().isEmpty() == false) {
                                Call<PostPutDelProduk> deleteHeros = mApiInterface.deleteHeros(ID);
                                deleteHeros.enqueue(new Callback<PostPutDelProduk>() {
                                    @Override
                                    public void onResponse(Call<PostPutDelProduk> call, Response<PostPutDelProduk> response) {
                                        ProdukDataActivity.ma.refresh();
                                        finish();
